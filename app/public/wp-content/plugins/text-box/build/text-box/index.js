...
function save({
  ...
  const classes = Object(function webpackMissingModule() { var e = new Error("Cannot find module 'classnames'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(`text-box-align-${alignment}`, {
    "has-shadow": shadow,
